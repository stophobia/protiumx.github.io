...
const whoami = {
  ...
  async exec(term, _args) {
    ...
    term.writeln(colorize(TermColors.Green, "current position: ") + "cloud engineer");
    term.writeln(
      colorize(TermColors.Green, "company: ") + "CrowdStrike < https://crowdstrike.com >",
    );
    term.writeln(colorize(TermColors.Green, "location: ") + "Munich, Germany");
    term.writeln(colorize(TermColors.Green, "fav languages: ") + "[golang, rust, c]");
